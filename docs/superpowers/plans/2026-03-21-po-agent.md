...
**Files:**
- Create: `.claude/skills/feature-deep-dev/po-agent-prompt.md`

- [ ] **Step 1: Write the PO agent prompt template**

Create `.claude/skills/feature-deep-dev/po-agent-prompt.md` with:
...
Run: `cat .claude/skills/feature-deep-dev/po-agent-prompt.md | head -5`
Expected: Shows the title and first few lines

- [ ] **Step 3: Commit**

```bash
git add .claude/skills/feature-deep-dev/po-agent-prompt.md
...
**Files:**
- Modify: `.claude/skills/feature-deep-dev-clarify/SKILL.md`
...
Read `.claude/skills/feature-deep-dev-clarify/SKILL.md` to understand the current structure.
...
Run: `head -4 .claude/skills/feature-deep-dev-clarify/SKILL.md`
Expected: `---`, `name: feature-deep-dev-clarify`, `description: ...`, `---`
